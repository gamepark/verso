  ...
  getBaseCoordinates(location: Location, context: MaterialContext) {
    ...
    switch (index) {
      case 0:
        ...
        if (context.rules.players.length === 5) return { x: -65, y: 22 }
        return { x: -65, y: 22 }
      case 1:
        ...
        if (context.rules.players.length === 5) return { x: -65, y: -13 }
        return { x: -65, y: -13 }
      case 2:
      ...
      case 3:
        ...
        return { x: 35, y: -13 }
      case 4:
        if (context.rules.players.length === 5) return { x: 35, y: 22 }
        return { x: 35, y: 22 }
      case 5:
      default:
        return { x: -14, y: 22 }
